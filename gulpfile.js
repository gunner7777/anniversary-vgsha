...
gulp.task("fonts", function () {
  return gulp.src(fontsInput).pipe(gulp.dest(fontsOutput));
});

gulp.task("vendor", function () {
  return gulp.src(vendorInput).pipe(gulp.dest(vendorOutput));
});

gulp.task("images", function () {
  return gulp.src(imgInput).pipe(gulp.dest(imgOutput));
});
